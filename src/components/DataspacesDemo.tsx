...
import DataSpaceManager from './DataSpaceManager';
    ...
    if (isLoading) {
      return (
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">Your Pod Dataspaces</h2>
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-card shadow-card border-dashed">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-lg">Pod Data Organization</CardTitle>
            <CardDescription>
              Your Pod automatically organizes data into these containers. Use the Data Spaces tab to create collaborative spaces.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <Button 
              variant="outline" 
              onClick={() => setActiveTab('dataspaces')}
